...
} from "../data/smithy-config.js";
import {
    loadArmamentsTable, loadEquipmentOptions,
    setSmithyOrder, getSmithyOrder, clearSmithyOrder,
    smithyCraftTurns, RARITY_CRAFTING,
                    ...
                    <div class="wita-smithy-order-row">
                        ...
                        <div class="wita-smithy-order-info">
                            ...
                            <div class="wita-smithy-order-meta">
                                <span class="wita-smithy-rarity-badge" style="${(() => { const c = getRarityColor(order.rarity); return c ? `color:${c};border-color:${c}` : ""; })()}">${rLabel}</span>
